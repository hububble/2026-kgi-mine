...
export const JourneyItemsList = {
  [JourneySceneType.金黃稻浪]: [
    { name: 'goldenRiceField-roadSign', path: 'scene-goldenRiceField-roadSign.png', top: -4, left: 2130, dissociation: 'back' },
    { name: 'goldenRiceField-item-1', path: 'scene-goldenRiceField-item-1.png', top: -20.7, left: 2739, dissociation: 'back' },
    { name: 'goldenRiceField-item-2', path: 'scene-goldenRiceField-item-2.png', top: -18.4, left: 1320, dissociation: 'back' },
    { name: 'goldenRiceField-item-3', path: 'scene-goldenRiceField-item-3.png', top: 1, left: 235, dissociation: 'back' },
    { name: 'goldenRiceField-item-4', path: 'scene-goldenRiceField-item-4.png', top: 10, left: 535, dissociation: 'back' },
    { name: 'goldenRiceField-item-5', path: 'scene-goldenRiceField-item-5.png', top: -6, left: 835, dissociation: 'back' },
    { name: 'goldenRiceField-item-6', path: 'scene-goldenRiceField-item-6.png', top: -19.5, left: 1685, dissociation: 'back' },
    { name: 'goldenRiceField-item-7', path: 'scene-goldenRiceField-item-7.png', top: -5.6, left: 3050, dissociation: 'back' },
  ],
  [JourneySceneType.花海平原]: [
    { name: 'flowerSeaPlain-roadSign', path: 'scene-flowerSeaPlain-roadSign.png', top: -4.5, left: 2035, dissociation: 'back' },
    { name: 'flowerSeaPlain-item-1', path: 'scene-flowerSeaPlain-item-1.png', top: -15.7, left: 1750, dissociation: 'back' },
    { name: 'flowerSeaPlain-item-2', path: 'scene-flowerSeaPlain-item-2.png', top: -10.3, left: 2990, dissociation: 'back' },
    { name: 'flowerSeaPlain-item-3', path: 'scene-flowerSeaPlain-item-3.png', top: -14, left: 670, dissociation: 'back' },
    { name: 'flowerSeaPlain-item-4', path: 'scene-flowerSeaPlain-item-4.png', top: -19.3, left: 2780, dissociation: 'back' },
    { name: 'flowerSeaPlain-item-5', path: 'scene-flowerSeaPlain-item-5.png', top: -11.9, left: 1180, dissociation: 'back' },
    { name: 'flowerSeaPlain-item-6', path: 'scene-flowerSeaPlain-item-6.png', top: -17.2, left: 2630, dissociation: 'back' },
    { name: 'flowerSeaPlain-item-7', path: 'scene-flowerSeaPlain-item-7.png', top: -22.7, left: 1495, dissociation: 'back' },
  ],
  [JourneySceneType.蔚藍海岸]: [
  ...
  [JourneySceneType.月夜雪地]: [
    { name: 'moonlitSnowfield-roadSign', path: 'scene-moonlitSnowfield-roadSign.png', top: -6.8, left: 2116, dissociation: 'back' },
    // { name: 'moonlitSnowfield-item-1', path: 'scene-moonlitSnowfield-item-1.png', top: -40, left: 1930 , dissociation: 'back'},
    { name: 'moonlitSnowfield-item-2', path: 'scene-moonlitSnowfield-item-2.png', top: -18, left: 1290, dissociation: 'back' },
    { name: 'moonlitSnowfield-item-3', path: 'scene-moonlitSnowfield-item-3.png', top: -28, left: 690, dissociation: 'back' },
    { name: 'moonlitSnowfield-item-4', path: 'scene-moonlitSnowfield-item-4.png', top: -27, left: 2220, dissociation: 'back' },
    { name: 'moonlitSnowfield-item-5', path: 'scene-moonlitSnowfield-item-5.png', top: -18, left: 2816, dissociation: 'back' },
    { name: 'moonlitSnowfield-item-6', path: 'scene-moonlitSnowfield-item-6.png', top: -8, left: 326, dissociation: 'back' },
